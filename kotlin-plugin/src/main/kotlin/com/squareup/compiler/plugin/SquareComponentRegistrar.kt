package com.squareup.compiler.plugin
...
class SquareComponentRegistrar : ComponentRegistrar {
    ...
    AnalysisHandlerExtension.registerExtension(project, object : AnalysisHandlerExtension {
      ...
      override fun analysisCompleted(
        ...
        classes.forEach { classDescriptor ->
          ...
          val directory = File(sourceGenFolder, "com/squareup/gen")
        ...
        return RetryWithAdditionalRoots(
            bindingTrace.bindingContext, module, emptyList(), listOf(sourceGenFolder), true
        )
      }
    })
  }
